...
# Load and train
try:
    model, poly, df = load_model_and_data('https://github.com/SamsonMayomiMatthew/industrial-energy-systems/blob/main/pm_model/Rollers%20Predictive%20Maintenance.xlsx')
    c0 = model.intercept_
    c1 = model.coef_[0]
    c2 = model.coef_[1]
